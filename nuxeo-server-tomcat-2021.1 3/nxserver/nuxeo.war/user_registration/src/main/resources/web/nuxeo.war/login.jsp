...
String bodyBackgroundStyle = LoginScreenHelper.getValueWithDefault(screenConfig.getBodyBackgroundStyle(), "no-repeat center center fixed #232F3E");
String loginButtonBackgroundColor = LoginScreenHelper.getValueWithDefault(screenConfig.getLoginButtonBackgroundColor(), "#00CAFF");
...
String logoWidth = LoginScreenHelper.getValueWithDefault(screenConfig.getLogoWidth(), "180");
String logoHeight = LoginScreenHelper.getValueWithDefault(screenConfig.getLogoHeight(), "50");
...
.idItem a, .idItem a:visited {
  background: url(<%=context%>/icons/default.png) no-repeat 5px center #00CAFF;
  ...
  <section>
    <div class="main">
      ...
      <form method="post" action="startup" autocomplete="<%= fieldAutocomplete %>">
        ...
        <div id="registerOption" class="loginOptions">
          <div class="idList">
            <div class="idItem">
              <a href="<%=context%>/user_registration"><fmt:message bundle="${messages}" key="amazon.label.register.button" /></a>
            </div>
            <a class="idReset" href="<%=context%>/user_registration/reset_request.html"><fmt:message bundle="${messages}" key="amazon.label.register.reset" /></a>
          </div>
        </div>
